...
async function testSingle() {
  console.log("=== SINGLE ADMIN AUTH TEST ===");
  console.log("Firebase Project:", firebaseConfig.projectId);

  // Test Admin@12345
  try {
    const res = await signInWithEmailAndPassword(auth, "admin@eroute.com", "Admin@12345");
    ...
    console.error("✕ AUTH FAILED with Admin@12345:", err.code, err.message);
  }
}
