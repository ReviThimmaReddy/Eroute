...
public class ConductorAuthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnAuthenticate).setOnClickListener(v -> {
            String email = "conductor@eroute.com";
            ...
            new Thread(() -> {
                ...
                runOnUiThread(() -> {
                    if (user != null) {
                        ...
                        android.content.Intent intent = new android.content.Intent(ConductorAuthActivity.this, ConductorDashboardActivity.class);
                        ...
                        android.widget.Toast.makeText(this, "Conductor credentials not found. Please log in once via Student gateway to initialize.", android.widget.Toast.LENGTH_LONG).show();
                    }
                });
            }).start();
        });
