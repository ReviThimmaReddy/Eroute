            ...
            new Thread(() -> {
                ...
                runOnUiThread(() -> {
                    if (user != null) {
                        ...
                        android.content.Intent intent = new android.content.Intent(AdminAuthActivity.this, AdminDashboardActivity.class);
                        ...
                        android.widget.Toast.makeText(this, "Admin credentials not found. Please log in once via Student gateway to initialize.", android.widget.Toast.LENGTH_LONG).show();
                    }
                });
            }).start();
        });
